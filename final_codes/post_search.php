...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    ...
    <div class="row">
        ...
        <form method="get" action="user_search_disp.php">
            <input id="sbox" type="text" placeholder="Search" aria-label="Search" name="search" required>
            <button id="button" class="btn btn-primary btn-sm" type="submit">Search</button>
        </form>
        </div>
    </div>    
    <div class="row">
